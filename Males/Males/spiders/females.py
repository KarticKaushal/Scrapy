...
class Females(scrapy.Spider):
    ...
    start_urls = ('https://healthyceleb.com/category/statistics/sports-stars/female-sports-stars/page/1',)
    custom_settings = {
    ...
    def parse_indetail(self, response):
        ...
        item['Name'] = response.xpath('//*[@id="post-'+str(response.url.split("/")[-1])+'"]/div[1]/header/h1/text()').extract_first().replace(" Height Weight Body Statistics","").replace(" Height, Weight, Age, Body Statistics","").replace("\xa0Height Weight Body Statistics","")
